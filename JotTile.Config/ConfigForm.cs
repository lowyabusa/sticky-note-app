...
namespace JotTile.Config
{
    internal sealed class ConfigForm : Form
    {
        ...
        private TabPage CreateAppearanceTab()
        {
            ...
            AddEditorRow(layout, 0, "Defaults", _restoreAppearanceDefaultsButton);
            AddEditorRow(layout, 1, "Background start", _backgroundStartCombo);
            AddEditorRow(layout, 2, "Background end", _backgroundEndCombo);
            AddEditorRow(layout, 3, "Text color", _textColorCombo);
            AddEditorRow(layout, 4, "Frame color", _frameColorCombo);
            AddEditorRow(layout, 5, "Frame thickness", _frameThickness);
            AddEditorRow(layout, 6, "Inner stroke color", _innerStrokeColorCombo);
            AddEditorRow(layout, 7, "Inner stroke thickness", _innerStrokeThickness);
            AddEditorRow(layout, 8, "Outer stroke color", _outerStrokeColorCombo);
            AddEditorRow(layout, 9, "Outer stroke thickness", _outerStrokeThickness);
            AddEditorRow(layout, 10, "Button color", _buttonColorCombo);
            AddEditorRow(layout, 11, "Button hover", _buttonHoverColorCombo);
            AddEditorRow(layout, 12, "Button disabled", _buttonDisabledColorCombo);
            AddEditorRow(layout, 13, "Gradient", _useGradientCheckBox);
            AddEditorRow(layout, 14, "Gradient direction", _gradientDirectionCombo);
            AddEditorRow(layout, 15, "Note font", _fontFamilyCombo);
            AddEditorRow(layout, 16, "Note text size", _fontSizeEditor);
